...
<AuthenticatedLayout>
    <template #header>
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Post in {{ society.name }}</h2>
    </template>
...
const submit = () => {
    form.put(route('societies.posts.update', [props.society.slug, props.post.slug]));
};
</script>